  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row items-center mt-32">
        ...
        <h3 className="text-gray_2 italic text-sm ml-10">
      ...
      <section>
        <div className="container px-5 py-16 mx-auto">
          <div className="flex flex-wrap -m-4">
            <div className="w-full h-full bg-gray_3 p-8 rounded">
              ...
              <div className="flex flex-row justify-center">
                <p className="leading-relaxed p-5 w w-4/5 text-white text-lg ">
                ...
                <svg
                  ...
                  fill="currentColor"
                  className="block w-16 h-16 text-gray_4 mb-4"
      ...
      <div className="w-full h-1 rounded bg-gray_3 mt-2">
        <div className="w-1/3 h-1 rounded bg-green_1" />
      </div>
    </div>
  )
}
