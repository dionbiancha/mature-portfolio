    ...
    <div className="flex sm:flex-row flex-col mb-20">
      <div className="sm:w-2/5 w-full mb-10">
        ...
        <p className="text-gray_2">
          Desde o início da minha jornada como desenvolvedor freelance, há quase
          2 anos, fiz trabalho remoto para agências e colaborei com pessoas
          talentosas para criar produtos digitais. Sou silenciosamente
          confiante, naturalmente curioso e trabalho perpetuamente para melhorar
          minhas habilidades profissionais, sempre em busca de novas
